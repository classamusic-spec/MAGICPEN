...
export const CREATURE_KINDS: CreatureKind[] = [
  { id: "fish",      label: "Fish",             behavior: "swim",    names: ["Bubbles", "Splash", "Finley", "Coral", "Wavy", "Ziggy"] },
  { id: "car",       label: "Car",              behavior: "drive",   names: ["Vroom", "Scooter", "Zoom", "Turbo", "Beep-Beep"] },
  { id: "sun",       label: "Sun",              behavior: "twinkle", names: ["Sunny", "Glowy", "Ray", "Goldie"] },
  { id: "star",      label: "Star",             behavior: "twinkle", names: ["Twinkle", "Nova", "Sparky", "Stella"] },
  { id: "bird",      label: "Bird",             behavior: "fly",     names: ["Flappy", "Sky", "Pip", "Winger"] },
  { id: "butterfly", label: "Butterfly",        behavior: "fly",     names: ["Flutter", "Petal", "Wings", "Mariposa"] },
  { id: "flower",    label: "Flower",           behavior: "grow",    names: ["Bloom", "Daisy", "Poppy", "Rosie"] },
  { id: "tree",      label: "Tree",             behavior: "grow",    names: ["Woody", "Leafy", "Oakie", "Sprout"] },
  { id: "snake",     label: "Snek",             behavior: "crawl",   names: ["Slither", "Noodle", "Wiggles", "Sssam"] },
  { id: "rainbow",   label: "Rainbow",          behavior: "float",   names: ["Arcy", "Prism", "Skittles", "Halo"] },
  { id: "balloon",   label: "Balloon",          behavior: "float",   names: ["Floaty", "Pop", "Helium", "Up"] },
  { id: "rocket",    label: "Rocket",           behavior: "fly",     names: ["Blastoff", "Comet", "Zoom-Zoom", "Astro"] },
  { id: "heart",     label: "Heart",            behavior: "bounce",  names: ["Lovey", "Sweetie", "Beat", "Hug"] },
  { id: "house",     label: "House",            behavior: "grow",    names: ["Homey", "Cottage", "Nook", "Shelly"] },
  { id: "mystery",   label: "Mystery Creature", behavior: "swim",    names: ["Doodle", "Squiggle", "Whatzit", "Scribble", "Zorp"] },
];
...
export const WORD_KINDS: CreatureKind[] = [
  ...
  { id: "duck",  label: "Duck",  behavior: "waddle",  names: ["Quackers", "Puddle", "Waddle", "Beaky"] },
  { id: "pig",   label: "Pig",   behavior: "graze",   names: ["Truffle", "Snout", "Pinky", "Oink"] },
  { id: "moon",  label: "Moon",  behavior: "twinkle", names: ["Luna", "Crescent", "Dozy", "Silver"] },
  { id: "apple", label: "Apple", behavior: "grow",    names: ["Pip", "Crunch", "Rosy", "Core"] },
  { id: "ball",  label: "Ball",  behavior: "bounce",  names: ["Bouncy", "Rolly", "Boing", "Spot"] },
  { id: "hat",   label: "Hat",   behavior: "float",   names: ["Topper", "Flop", "Brim", "Tip"] },
  { id: "bus",   label: "Bus",   behavior: "drive",   names: ["Rumble", "Doors", "Big Red", "Toot"] },
  { id: "cake",  label: "Cake",  behavior: "grow",    names: ["Sprinkle", "Frosting", "Cherry", "Slice"] },
];
...
export const WORLD_KINDS: CreatureKind[] = [
  /* ── Magic Reef ─────────────────────────────────────────────────────────── */
  { id: "starfish",    label: "Starfish",    behavior: "crawl",   names: ["Twinkletoes", "Sandy", "Wishy", "Five-Points", "Glitter"] },
  { id: "octopus",     label: "Octopus",     behavior: "jet",     names: ["Inky", "Eight-Arms", "Squishy", "Noodle-Arms", "Blub"] },
  { id: "crab",        label: "Crab",        behavior: "scuttle", names: ["Pinchy", "Sideways", "Clacky", "Snip-Snap", "Shelly"] },
  { id: "seahorse",    label: "Seahorse",    behavior: "swim",    names: ["Curly", "Twirl", "Sea-Pony", "Bobbin", "Ripple"] },
  { id: "turtle",      label: "Turtle",      behavior: "swim",    names: ["Shelldon", "Slowpoke", "Paddle", "Domey", "Tuck"] },
  { id: "shark",       label: "Shark",       behavior: "swim",    names: ["Chomper", "Toothy", "Finny", "Big Grin", "Zoomer"] },
  { id: "jellyfish",   label: "Jellyfish",   behavior: "jet",     names: ["Wobble", "Squish", "Glowy", "Bloop", "Jelly-Belly"] },
  { id: "whale",       label: "Whale",       behavior: "swim",    names: ["Big Blue", "Spout", "Gulp", "Songy", "Splashy"] },

  /* ── Giggle Galaxy ──────────────────────────────────────────────────────── */
  { id: "planet",      label: "Planet",      behavior: "orbit",   names: ["Ringo", "Bumpy", "Spinny", "Swirl", "Big Ball"] },
  { id: "mercury",     label: "Mercury",     behavior: "orbit",   names: ["Speedy", "Zippy", "Little Rock", "Sizzle"] },
  { id: "venus",       label: "Venus",       behavior: "orbit",   names: ["Cloudy", "Toasty", "Puff", "Shimmer"] },
  { id: "mars",        label: "Mars",        behavior: "orbit",   names: ["Rusty", "Red-Red", "Dusty", "Blush"] },
  { id: "ufo",         label: "UFO",         behavior: "hover",   names: ["Beep-Boop", "Saucer", "Blinky", "Whoosh", "Zoop"] },
  { id: "alien",       label: "Alien",       behavior: "bounce",  names: ["Zorb", "Blip", "Greenie", "Bloop-Bloop", "Squeek"] },
  { id: "astronaut",   label: "Astronaut",   behavior: "float",   names: ["Bouncy Boots", "Star Hopper", "Bubble-Head", "Moonwalker"] },
  { id: "comet",       label: "Comet",       behavior: "streak",  names: ["Swoosh", "Sparktail", "Dash", "Glimmer", "Zing"] },
  { id: "satellite",   label: "Satellite",   behavior: "orbit",   names: ["Beep", "Wing-Ding", "Ping", "Chirpy", "Antenna"] },

  /* ── Sunny Farm ─────────────────────────────────────────────────────────── */
  { id: "cow",         label: "Cow",         behavior: "graze",   names: ["Moo-Moo", "Buttercup", "Spots", "Clover", "Bessie"] },
  { id: "chicken",     label: "Chicken",     behavior: "waddle",  names: ["Cluck-Cluck", "Feathers", "Peck", "Henrietta", "Fluffy"] },
  { id: "sheep",       label: "Sheep",       behavior: "graze",   names: ["Woolly", "Baa-Baa", "Puffball", "Marshmallow", "Nibble"] },
  { id: "horse",       label: "Horse",       behavior: "graze",   names: ["Clip-Clop", "Sugar", "Gallop", "Star-Nose", "Pepper"] },
  { id: "barn",        label: "Barn",        behavior: "grow",    names: ["Red Roof", "Hay House", "Creaky", "Cozy", "Big Doors"] },
  { id: "tractor",     label: "Tractor",     behavior: "drive",   names: ["Chugger", "Putt-Putt", "Big Wheels", "Muddy", "Tilly"] },

  /* ── Dino Island ────────────────────────────────────────────────────────── */
  { id: "trex",        label: "T-Rex",       behavior: "stomp",   names: ["Chompy", "Tiny Arms", "Roary", "Rexy", "Big Teeth"] },
  { id: "triceratops", label: "Triceratops", behavior: "stomp",   names: ["Three-Horn", "Frilly", "Bonk", "Trixie", "Charger"] },
  { id: "stegosaurus", label: "Stegosaurus", behavior: "stomp",   names: ["Spike", "Steggy", "Platey", "Thwack", "Diamond-Back"] },
  { id: "pterodactyl", label: "Pterodactyl", behavior: "fly",     names: ["Screech", "Wingnut", "Glider", "Swoopy", "Kite"] },
  { id: "longneck",    label: "Long-neck",   behavior: "stomp",   names: ["Stretch", "Tall-Boy", "Necky", "Munch", "Treetop"] },
  { id: "egg",         label: "Dino Egg",    behavior: "bounce",  names: ["Crackle", "Hatchy", "Speckles", "Peep", "Wibble"] },
  { id: "volcano",     label: "Volcano",     behavior: "erupt",   names: ["Rumbly", "Puffs", "Hot-Top", "Boom-Boom", "Smokey"] },
  { id: "palmtree",    label: "Palm Tree",   behavior: "sway",    names: ["Swishy", "Coco", "Fronds", "Breezy", "Tall Tom"] },
];
